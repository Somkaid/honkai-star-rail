...
class CharacterController2 extends Controller
{
    public function randomCharacter()
    {
   
   $characters = json_decode(file_get_contents(resource_path('data/characters2.json')), true);
        ...
        return view('random2', compact('character', 'stars'));
    ...
    public function randomTenCharacters()
    {
        ...
        return view('random-ten2', compact('result'));
    }
}
